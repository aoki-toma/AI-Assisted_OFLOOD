...
# 1. Simulation Engine
ENGINE="amber" # gromacs or amber
AMBER_MD_CMD="pmemd.cuda"
...
# 5. MD Input Files
SAMPLING_PARAM_FILE="${PROJECT_DIR}/mdin/sampling.in"
PRODUCTION_PARAM_FILE="${PROJECT_DIR}/mdin/production.in"
